  ...
  return (
    <Layout>
      <div className="flex flex-col w-full">
        <div className="h-48 md:h-64 bg-gradient-to-r from-klozui-green-600/90 to-klozui-green-600 relative">
              ...
              <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-4 mb-4">
                <div>
                  <h1 className="text-2xl font-bold flex items-center gap-2">
                    {user.name}
                    {user.isRegistered && (
                      <span className="bg-klozui-green-600/10 text-klozui-green-600 text-xs px-2 py-0.5 rounded-full flex items-center">
                      ...
                      <Button
                        className={cn(
                          ...
                          isFollowing
                            ...
                            : "bg-klozui-green-600 hover:bg-klozui-green-600/90 text-white"
                        )}
                      ...
                      >
                        {isFollowing ? (
                          <>
                            <Heart
                              size={16}
                              className="mr-2 fill-klozui-green-600 text-klozui-green-600"
                            />
                            Following
                          </>
                        ) : (
          ...
          >
            <TabsList className="w-full justify-start border-b rounded-none bg-transparent h-auto p-0">
              <TabsTrigger
                value="products"
                className={cn(
                  "rounded-none border-b-2 border-transparent px-4 py-2 data-[state=active]:border-klozui-green-600 data-[state=active]:bg-transparent",
              ...
              <div className="max-w-3xl space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-start gap-2">
                    <MapPin
                      size={20}
                      className="mt-0.5 flex-shrink-0 text-klozui-green-600"
                    />
                    <div>
