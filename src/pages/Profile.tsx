...
const sampleReviews = [
  ...
  },
  {
    ...
    reviewerImage: '',
    rating: 4,
    comment: 'Great quality products. The hibiscus toner is refreshing and smells wonderful.',
            ...
            <TabsContent value="reviews" className="pt-6">
              <div className="max-w-3xl">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold">Reviews ({sampleReviews.length})</h3>
                  <Button variant="outline" className="text-sm">
